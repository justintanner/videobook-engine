...
module.exports = function (/**String*/ input, /** object */ options) {
    ...
    return {
        ...
        extractEntryTo: function (entry, targetPath, maintainEntryPath, overwrite, keepOriginalPermission, outFileName) {
            ...
            var root = pth.resolve(pth.normalize(targetPath));
            ...
            if (item.isDirectory) {
                ...
                children.forEach(function (child) {
                    ...
                    filetools.writeFileTo(childName, content, overwrite, fileAttr, root);
                });
                return true;
            }
            ...
            filetools.writeFileTo(target, content, overwrite, fileAttr, root);
        ...
        extractAllTo: function (targetPath, overwrite, keepOriginalPermission, pass) {
            ...
            const dirEntries = [];
            const root = pth.resolve(pth.normalize(targetPath));
            _zip.entries.forEach(function (entry) {
                var entryName = sanitize(targetPath, canonical(entry.entryName));
                if (entry.isDirectory) {
                    filetools.makeDir(entryName, root);
                ...
                // The reverse operation for attr depend on method addFile()
                const fileAttr = keepOriginalPermission ? entry.header.fileAttr : undefined;
                filetools.writeFileTo(entryName, content, overwrite, fileAttr, root);
                try {
        ...
        extractAllToAsync: function (targetPath, overwrite, keepOriginalPermission, callback) {
            ...
            for (const entry of dirEntries) {
                ...
                try {
                    filetools.makeDir(dirPath, targetPath);
                } catch (er) {
